"""
Django settings for HW_03 project.
...
SECRET_KEY = 'django-insecure-wg91ls&f+5bsz1$hjo@03(j7*ztwdkkhsv%ta!k3ci@l^csv(3'
...
WSGI_APPLICATION = 'HW_03.wsgi.application'
